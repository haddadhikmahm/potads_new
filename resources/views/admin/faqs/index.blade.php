...
<div class="mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
    <form action="{{ route('admin.faqs.index') }}" method="GET" class="flex gap-2 w-full md:w-auto">
        ...
        @if(request('search'))
            <a href="{{ route('admin.faqs.index') }}" class="p-2.5 bg-red-50 text-red-500 rounded-xl hover:bg-red-100 transition-all" title="Reset">
