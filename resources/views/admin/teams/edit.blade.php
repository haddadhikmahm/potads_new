...
<div class="max-w-4xl">
    <div class="bg-white rounded-[2.5rem] shadow-sm border border-slate-100 p-8 md:p-12">
        <form action="{{ route('admin.teams.update', $team) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="number" name="order" value="{{ old('order', $team->order) }}" required
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="description" rows="3"
                        class="w-full px-6 py-4 bg-slate-50 border-none rounded-2xl focus:ring-2 focus:ring-potads-blue/10 transition-all text-slate-700 font-medium @error('description') ring-2 ring-red-500/20 @enderror">{{ old('description', $team->description) }}</textarea>
                ...
                <div class="space-y-2">
                    ...
                    @if($team->image)
                        <div class="mb-3">
                            <img src="{{ asset('storage/' . $team->image) }}" class="w-24 h-24 object-cover rounded-xl border border-slate-200">
                        </div>
                    @endif
                    ...
                    <p class="text-xs text-slate-400 mt-1 ml-1">Biarkan kosong jika tidak ingin mengubah foto.</p>
