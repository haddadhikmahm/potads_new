...
@section('title', 'Pendataan Anak Down Syndrome')
        ...
        <div class="bg-white rounded-[2.5rem] shadow-xl border-4 border-white p-8 md:p-12" data-aos="fade-up">
            <div class="text-center mb-12">
                <div class="w-20 h-20 bg-potads-yellow rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-lg shadow-yellow-200">
                    <i data-lucide="baby" class="w-10 h-10 text-potads-blue"></i>
                </div>
                <h1 class="text-3xl font-black text-potads-blue mb-4">Data Anak Down Syndrome</h1>
                <p class="text-gray-500">Silakan isi formulir di bawah ini untuk mendata putra/putri Anda.</p>
            </div>
            ...
            <form action="{{ route('children.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="md:col-span-2 flex flex-col items-center">
                        <div class="w-32 h-32 bg-slate-50 rounded-[2rem] border-4 border-dashed border-slate-200 flex items-center justify-center relative overflow-hidden group cursor-pointer" onclick="document.getElementById('photo-input').click()">
                            ...
                            <div id="photo-placeholder" class="text-center flex flex-col items-center">
                    ...
                    <div class="space-y-2 md:col-span-2">
                        ...
                        <textarea name="medical_notes" rows="4"
                            class="w-full px-6 py-4 bg-slate-50 border-none rounded-2xl focus:ring-4 focus:ring-potads-blue/5 transition-all text-slate-700 font-bold"
                            placeholder="Sebutkan jika ada riwayat kesehatan atau kebutuhan khusus lainnya...">{{ old('medical_notes') }}</textarea>
                    </div>
                </div>
                ...
                <div class="flex flex-col md:flex-row gap-4 pt-6">
                    ...
                    <a href="{{ route('profile.edit') }}" class="px-10 py-5 bg-white border-4 border-slate-100 text-slate-400 font-black rounded-3xl text-lg text-center hover:bg-slate-50 transition-all">
                        Batal
                    </a>
                </div>
            </form>
